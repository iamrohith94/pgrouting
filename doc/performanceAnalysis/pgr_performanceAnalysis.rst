...
.. _pgr_performanceAnalysis:

pgr_performanceAnalysis
===============================================================================

``pgr_performanceAnalysis`` — Returns the shortest path(s) using Dijkstra algorithm.
...
.. index::
    single: performanceAnalysis(Minimal Use)
...
.. code-block:: none
    ...
    pgr_performanceAnalysis(edges_sql, start_vid, end_vid)
...
.. literalinclude:: doc-pgr_performanceAnalysis.queries
   :start-after: -- q1
   :end-before: -- q2


.. index::
    single: performanceAnalysis(Complete signature)
...
.. code-block:: none
    ...
    pgr_performanceAnalysis(edges_sql, start_vid, end_vid, directed);
    RETURNS SET OF (seq, path_seq, node, edge, cost, agg_cost) or EMPTY SET
