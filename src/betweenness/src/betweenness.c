...
#include "drivers/betweenness/betweenness_driver.h"  // the link to the C++ code of the function

PGDLLEXPORT Datum betweenness(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(betweenness);
...
process(
    ...
    time_msg(" processing pgr_betweenness", start_t, clock());
